...
(function(exports) {
  ...
  var Commit = (function () {
      function Commit(value0) {
          this.value0 = value0;
      };
      Commit.create = function (value0) {
          return new Commit(value0);
      };
      return Commit;
  })();
  var decodeDateTime = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("dayOfWeek"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("month"))(function (v2) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("day"))(function (v3) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("time"))(function (v4) {
                          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonInt)(v)("year"))(function (v5) {
                              return Control_Applicative.pure(Data_Either.applicativeEither)(new DateTime({
                                  dayOfWeek: v1, 
                                  month: v2, 
                                  day: v3, 
                                  time: v4, 
  ...
  var decodeCommit = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("sha"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("author"))(function (v2) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(decodeDateTime)(v)("date"))(function (v3) {
                      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("message"))(function (v4) {
                          return Control_Applicative.pure(Data_Either.applicativeEither)(new Commit({
                              sha: v1, 
                              author: v2, 
                              date: v3, 
                              message: v4
  ...
  var decodeLog = function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(Data_Argonaut_Decode_Class.decodeJson(decodeCommit)));
  };
...
})(PS["Hits.Log.Types"] = PS["Hits.Log.Types"] || {});
(function(exports) {
  /* global exports */
...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Hits_Log_Types = PS["Hits.Log.Types"];
  ...
  var log = (function () {
      var render = function (state) {
          var listCommit = function (v) {
              return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_("commit") ])([ Halogen_HTML_Core.text(v.value0.message) ]);
          };
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("log") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("log") ]), Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(listCommit)(state.log)) ]);
      };
      var initialState = {
          loading: false, 
          log: [  ]
      ...
      var $$eval = (function () {
          var commits = function (json) {
              var v = Hits_Log_Types.decodeLog(json);
              if (v instanceof Data_Either.Right) {
                  return v.value0;
              };
              if (v instanceof Data_Either.Left) {
                  return [ new Hits_Log_Types.Commit({
                      sha: "this is the message", 
                      author: "asdf", 
                      date: new Hits_Log_Types.DateTime({
                          dayOfWeek: "", 
                          month: "", 
                          day: 1, 
                          time: "", 
              ...
              throw new Error("Failed pattern match at Hits.Log line 55, column 30 - line 57, column 167: " + [ v.constructor.name ]);
          };
          return function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableJson)("http://localhost:8080/log")))(function (v1) {
...
(function(exports) {
  ...
  var Renamed = (function () {
      ...
      Renamed.value = new Renamed();
      return Renamed;
  })();
  var FileChange = (function () {
      function FileChange(value0) {
          this.value0 = value0;
      };
      FileChange.create = function (value0) {
          return new FileChange(value0);
      };
      return FileChange;
  })();
  var showChangeType = new Data_Show.Show(function (v) {
      if (v instanceof Added) {
          return "Added";
      };
      if (v instanceof Deleted) {
          return "Deleted";
      };
      if (v instanceof Modified) {
          return "Modified";
      };
      if (v instanceof Renamed) {
          return "Renamed";
      };
      throw new Error("Failed pattern match at Hits.Status.Types line 19, column 3 - line 20, column 3: " + [ v.constructor.name ]);
  });
  var decodeFileChange = new Data_Argonaut_Decode_Class.DecodeJson(function (json) {
      var changeTypeEither = function (v) {
          if (v === "Added") {
              return new Data_Either.Right(Added.value);
          };
          if (v === "Deleted") {
              return new Data_Either.Right(Deleted.value);
          };
          if (v === "Modified") {
              return new Data_Either.Right(Modified.value);
          };
          if (v === "Renamed") {
              return new Data_Either.Right(Renamed.value);
          };
          return new Data_Either.Left("was not one of {Added|Deleted|Modified|Renamed}");
      };
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeStrMap(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(function (v) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("changeType"))(function (v1) {
              return Control_Bind.bind(Data_Either.bindEither)(changeTypeEither(v1))(function (v2) {
                  return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Combinators.getField(Data_Argonaut_Decode_Class.decodeJsonString)(v)("fileName"))(function (v3) {
                      return Control_Applicative.pure(Data_Either.applicativeEither)(new FileChange({
                          changeType: v2, 
                          fileName: v3
                      }));
                  });
  ...
  var decodeFileChanges = function (json) {
      return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonJson))(json))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Data_Either.applicativeEither)(Data_Argonaut_Decode_Class.decodeJson(decodeFileChange)));
  };
  exports["Added"] = Added;
  ...
  exports["decodeFileChanges"] = decodeFileChanges;
  exports["showChangeType"] = showChangeType;
  exports["decodeFileChange"] = decodeFileChange;
})(PS["Hits.Status.Types"] = PS["Hits.Status.Types"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Hits_Status_Types = PS["Hits.Status.Types"];
  var Network_HTTP_Affjax = PS["Network.HTTP.Affjax"];
  var Network_HTTP_Affjax_Response = PS["Network.HTTP.Affjax.Response"];
  var Prelude = PS["Prelude"];        
  var Status = (function () {
  ...
  var status = (function () {
      var render = function (state) {
          var listChange = function (v) {
              return Halogen_HTML_Elements.li([ Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName(Data_Show.show(Hits_Status_Types.showChangeType)(v.value0.changeType))) ])([ Halogen_HTML_Core.text(v.value0.fileName) ]);
          };
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("status") ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("status") ]), Halogen_HTML_Elements.ul_(Data_Functor.map(Data_Functor.functorArray)(listChange)(state.changes)) ]);
      };
      var initialState = {
          loading: false, 
          changes: [  ]
      ...
      var $$eval = (function () {
          var fileChanges = function (json) {
              var v = Hits_Status_Types.decodeFileChanges(json);
              if (v instanceof Data_Either.Right) {
                  return v.value0;
              };
              return [  ];
          ...
          return function (v) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableJson)("http://localhost:8080/status")))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          var $15 = {};
                          for (var $16 in v2) {
                          ...
                          $15.loading = false;
                          $15.changes = fileChanges(v1.response);
                          return $15;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
...
(function(exports) {
  ...
  var Hits_Log = PS["Hits.Log"];
  var Hits_Status = PS["Hits.Status"];
  var Network_HTTP_Affjax = PS["Network.HTTP.Affjax"];
  var Prelude = PS["Prelude"];        
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Hits_Status.status)(Data_Unit.unit)(v))(function (v1) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Hits_Log.log)(Data_Unit.unit)(v))(function (v2) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(v1.query(Halogen_Query.action(Hits_Status.Status.create)))(function () {
                  return v2.query(Halogen_Query.action(Hits_Log.Log.create));
              });
          });
      });
  }));
